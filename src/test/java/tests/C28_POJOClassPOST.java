...
public class C28_POJOClassPOST extends BaseUrlHerOkuApp {
    ...
    @Test
    public void test01(){
        // Endpoint ve Request Body hazırlama aşamasındayız:
        specHerOkuApp.pathParam("pp1","booking");

        PojoHerOkuAppBookingdates bookingdatesPOJO = new PojoHerOkuAppBookingdates("2021-06-01","2021-06-10");
        PojoHerOkuAppRequestBody reqBodyPOJO = new PojoHerOkuAppRequestBody("Ahmet","Bulut",500,false,bookingdatesPOJO,"wi-fi");

        // ExpectedBody oluşturma:
        ...
        // Response kaydet ve Request gönder
