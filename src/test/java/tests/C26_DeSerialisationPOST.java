...
public class C26_DeSerialisationPOST extends BaseUrlHerOkuApp {
    ...
    public void test01(){
        ...
        Map<String,Object> reqBody = HerOkuAppData.reqBodyOlustur();
        Map<String,Object> expBody = HerOkuAppData.expBodyOlustur();
