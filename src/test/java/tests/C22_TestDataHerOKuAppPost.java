...
public class C22_TestDataHerOKuAppPost extends BaseUrlHerOkuApp {
        /*
                ...
                """ bookingid haric """ asagidaki gibi oldugunu test edin.
    ...
    public void test01(){
        ...
        JSONObject reqBody = HerOkuAppData.JsonReqBodyOlustur();

        JSONObject expBody = HerOkuAppData.JsonexpBodyOlustur();
